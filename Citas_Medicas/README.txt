...
a persistence unit "Citas_MedicasPersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/pro/ups/Citas_Medicas/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "Citas_Medicas/pom.xml":
...
artifact ("Citas_Medicas.war") is already built. You can build
